...
#setwd('/Users/hendryd/Dropbox (Personal)/Documents/Projects/ParkHendry/ConflictEventsAndPublicOpinion/Analysis')
setwd('/Users/david.hendry/Dropbox (Personal)/Documents/Projects/ParkHendry/ConflictEventsAndPublicOpinion/Analysis')
...
ab03 %>% filter(cname_eng == 'Madagascar') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Madagascar') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Madagascar') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Madagascar') %>% {sort(unique(.$areaname_eng_ab))}

geo_madagascar %>% group_by(NAME_1, ID_1, NAME_2, ID_2, NAME_3, ID_3) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Malawi') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Malawi') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Malawi') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Malawi') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Malawi') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Malawi') %>% {sort(unique(.$areaname_eng_ab))}

geo_malawi <-
  read.csv('Data/GIS/Malawi/MWI_adm3.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_malawi %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Mali') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Mali') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Mali') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Mali') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Mali') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Mali') %>% {sort(unique(.$areaname_eng_ab))}

geo_mali <-
  read.csv('Data/GIS/Mali/MLI_adm4.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_mali %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)


'Mauritius' %in% ab01$cname_eng
'Mauritius' %in% ab02$cname_eng
'Mauritius' %in% ab03$cname_eng
'Mauritius' %in% ab04$cname_eng
'Mauritius' %in% ab05$cname_eng
'Mauritius' %in% ab06$cname_eng

ab05 %>% filter(cname_eng == 'Mauritius') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Mauritius') %>% {sort(unique(.$areaname_eng_ab))}

geo_mauritius <-
  read.csv('Data/GIS/Mauritius/MUS_adm1.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_mauritius %>% group_by(NAME_1, ID_1) %>% summarize() %>% print(n = Inf)
...
ab05 %>% filter(cname_eng == 'Morocco') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Morocco') %>% {sort(unique(.$areaname_eng_ab))}

geo_morocco <-
  read.csv('Data/GIS/Morocco/MAR_adm4.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_morocco %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab02 %>% filter(cname_eng == 'Mozambique') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Mozambique') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Mozambique') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Mozambique') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Mozambique') %>% {sort(unique(.$areaname_eng_ab))}

geo_mozambique <-
  read.csv('Data/GIS/Mozambique/MOZ_adm3.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_mozambique %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Namibia') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Namibia') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Namibia') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Namibia') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Namibia') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Namibia') %>% {sort(unique(.$areaname_eng_ab))}

geo_namibia <-
  read.csv('Data/GIS/Namibia/NAM_adm2.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_namibia %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab05 %>% filter(cname_eng == 'Niger') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Niger') %>% {sort(unique(.$areaname_eng_ab))}

geo_niger <-
  read.csv('Data/GIS/Niger/NER_adm3.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_niger %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Nigeria') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Nigeria') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Nigeria') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Nigeria') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Nigeria') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Nigeria') %>% {sort(unique(.$areaname_eng_ab))}

geo_nigeria <-
  read.csv('Data/GIS/Nigeria/NGA_adm2.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_nigeria %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab06 %>% filter(cname_eng == 'Sao Tome and Principe') %>% {sort(unique(.$areaname_eng_ab))}

geo_saotomeandprincipe <-
  read.csv('Data/GIS/SaoTomeAndPrincipe/STP_adm1.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_saotomeandprincipe %>% group_by(NAME_1, ID_1) %>% summarize() %>% print(n = Inf)
...
ab02 %>% filter(cname_eng == 'Senegal') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Senegal') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Senegal') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Senegal') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Senegal') %>% {sort(unique(.$areaname_eng_ab))}

geo_senegal <-
  read.csv('Data/GIS/Senegal/SEN_adm4.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_senegal %>% group_by(NAME_1, ID_1, NAME_2, ID_2, NAME_3, ID_3) %>% summarize() %>% print(n = Inf)
...
ab05 %>% filter(cname_eng == 'Sierra Leone') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Sierra Leone') %>% {sort(unique(.$areaname_eng_ab))}

geo_sierraleone <-
  read.csv('Data/GIS/SierraLeone/SLE_adm3.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_sierraleone %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'South Africa') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'South Africa') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'South Africa') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'South Africa') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'South Africa') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'South Africa') %>% {sort(unique(.$areaname_eng_ab))}

geo_southafrica <-
  read.csv('Data/GIS/SouthAfrica/ZAF_adm2.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_southafrica %>% group_by(NAME_1, ID_1) %>% summarize() %>% print(n = Inf)
...
ab05 %>% filter(cname_eng == 'Sudan') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Sudan') %>% {sort(unique(.$areaname_eng_ab))}

geo_sudan <-
  read.csv('Data/GIS/Sudan/SDN_adm3.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_sudan %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab05 %>% filter(cname_eng == 'Swaziland') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Swaziland') %>% {sort(unique(.$areaname_eng_ab))}

geo_swaziland <-
  read.csv('Data/GIS/Swaziland/SWZ_adm1.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_swaziland %>% group_by(NAME_1, ID_1) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Tanzania') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Tanzania') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Tanzania') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Tanzania') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Tanzania') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Tanzania') %>% {sort(unique(.$areaname_eng_ab))}

geo_tanzania <-
  read.csv('Data/GIS/Tanzania/TZA_adm3.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_tanzania %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab05 %>% filter(cname_eng == 'Togo') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Togo') %>% {sort(unique(.$areaname_eng_ab))}

geo_togo <-
  read.csv('Data/GIS/Togo/TGO_adm2.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_togo %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab05 %>% filter(cname_eng == 'Tunisia') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Tunisia') %>% {sort(unique(.$areaname_eng_ab))}

geo_tunisia <-
  read.csv('Data/GIS/Tunisia/TUN_adm2.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_tunisia %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Uganda') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Uganda') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Uganda') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Uganda') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Uganda') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Uganda') %>% {sort(unique(.$areaname_eng_ab))}

geo_uganda <-
  read.csv('Data/GIS/Uganda/UGA_adm4.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_uganda %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Zambia') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Zambia') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Zambia') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Zambia') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Zambia') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Zambia') %>% {sort(unique(.$areaname_eng_ab))}

geo_zambia <-
  read.csv('Data/GIS/Zambia/ZMB_adm2.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_zambia %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
...
ab01 %>% filter(cname_eng == 'Zimbabwe') %>% {sort(unique(.$areaname_eng_ab))}
ab02 %>% filter(cname_eng == 'Zimbabwe') %>% {sort(unique(.$areaname_eng_ab))}
ab03 %>% filter(cname_eng == 'Zimbabwe') %>% {sort(unique(.$areaname_eng_ab))}
ab04 %>% filter(cname_eng == 'Zimbabwe') %>% {sort(unique(.$areaname_eng_ab))}
ab05 %>% filter(cname_eng == 'Zimbabwe') %>% {sort(unique(.$areaname_eng_ab))}
ab06 %>% filter(cname_eng == 'Zimbabwe') %>% {sort(unique(.$areaname_eng_ab))}

geo_zimbabwe <-
  read.csv('Data/GIS/Zimbabwe/ZWE_adm2.csv', stringsAsFactors = FALSE) %>%
  as_tibble()

geo_zimbabwe %>% group_by(NAME_1, ID_1, NAME_2, ID_2) %>% summarize() %>% print(n = Inf)
